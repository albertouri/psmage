...
void RenderArea::generateTXT(int size)
{
	...
	mapBuffer.drawLineDownToHigh(11, 110, 0, 116);
	mapBuffer.drawLineDownToHigh(11, 110, 23, 128);
	mapBuffer.drawLineDownToHigh(23, 87, 17, 92);
	mapBuffer.drawLineDownToHigh(28, 8, 17, 38);
	mapBuffer.drawLineDownToHigh(28, 122, 23, 128);
	mapBuffer.drawLineDownToHigh(44, 93, 23, 87);
	mapBuffer.drawLineDownToHigh(52, 65, 44, 93);
	mapBuffer.drawLineDownToHigh(50, 30, 45, 18);
	mapBuffer.drawLineDownToHigh(45, 112, 51, 129);
	mapBuffer.drawLineDownToHigh(64, 6, 50, 30);
	mapBuffer.drawLineDownToHigh(64, 6, 78, 30);
	mapBuffer.drawLineDownToHigh(76, 65, 84, 93);
	mapBuffer.drawLineDownToHigh(83, 112, 77, 129);
	mapBuffer.drawLineDownToHigh(78, 30, 83, 18);
	mapBuffer.drawLineDownToHigh(84, 93, 105, 87);
	mapBuffer.drawLineDownToHigh(100, 8, 111, 38);
	mapBuffer.drawLineDownToHigh(100, 122, 105, 128);
	mapBuffer.drawLineDownToHigh(105, 87, 111, 92);
	mapBuffer.drawLineDownToHigh(117, 110, 105, 128);
	mapBuffer.drawLineDownToHigh(117, 110, 128, 116);
	//mapBuffer.drawLineHighToDown(11, 20, 0, 14);
	//mapBuffer.drawLineHighToDown(11, 20, 23, 2);
	//mapBuffer.drawLineHighToDown(23, 43, 17, 38);
	//mapBuffer.drawLineHighToDown(28, 122, 17, 92);
	//mapBuffer.drawLineHighToDown(28, 8, 23, 2);
	//mapBuffer.drawLineHighToDown(44, 37, 23, 43);
	//mapBuffer.drawLineHighToDown(52, 65, 44, 37);
	//mapBuffer.drawLineHighToDown(50, 100, 45, 112);
	//mapBuffer.drawLineHighToDown(45, 18, 51, 1);
	//mapBuffer.drawLineHighToDown(64, 124, 50, 100);
	//mapBuffer.drawLineHighToDown(64, 124, 78, 100);
	//mapBuffer.drawLineHighToDown(76, 65, 84, 37);
	//mapBuffer.drawLineHighToDown(83, 18, 77, 1);
	//mapBuffer.drawLineHighToDown(78, 100, 83, 112);
	//mapBuffer.drawLineHighToDown(84, 37, 105, 43);
	//mapBuffer.drawLineHighToDown(100, 122, 111, 92);
	//mapBuffer.drawLineHighToDown(100, 8, 105, 2);
	//mapBuffer.drawLineHighToDown(105, 43, 111, 38);
	//mapBuffer.drawLineHighToDown(117, 20, 105, 2);
	//mapBuffer.drawLineHighToDown(117, 20, 128, 14);
